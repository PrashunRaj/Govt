...
//       description: "Proposal to renovate the local park with new playground equipment and better lighting",
...
//       description: "Installation of traffic signals and speed bumps in residential areas",
//       image: "/api/placeholder/400/200",
//       upvotes: 234,
//       downvotes: 18,
//       comments: 67,
...
//         <nav className="mt-8">
//           <SidebarItem icon={<Home />} text="Overview" isOpen={isSidebarOpen} />
...
//       likes: 8
//     },
//     // Add more comments for testing scroll
...
//       status: "Under Review"
//     },
//     // Add more proposals to test scrolling
//     ...Array(8).fill(null).map((_, index) => ({
//       id: index + 2,
//       title: `Sample Proposal ${index + 2}`,
//       description: "A sample proposal description for testing the scroll functionality",
//       image: "/api/placeholder/400/200",
